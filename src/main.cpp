...
#include <vector>
#include <memory>
#include "GLViewPhysicsModule.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewPhysicsModule > glView( Aftr::GLViewPhysicsModule::New( args ) );
